...
# Save figure
ggsave("final_plot_gapseq_2.pdf", plot = final_plot, width = 20, height = 12, units = "in", dpi = 320, bg = "white")
ggsave("final_plot_gapseq_2.png", plot = final_plot, width = 20, height = 12, units = "in", dpi = 320, bg = "white")
