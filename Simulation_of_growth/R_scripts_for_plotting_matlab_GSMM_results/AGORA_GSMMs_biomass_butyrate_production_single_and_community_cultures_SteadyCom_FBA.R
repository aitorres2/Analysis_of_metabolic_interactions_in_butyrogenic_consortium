...
diseño_consorcios_data <- read_excel("diseño_consorcios_tesis_Alexis_AGORA_vFINAL.xlsx", sheet = 1, col_names = TRUE)
...
mono_subset <- mono_subset[!grepl("B_longum_E18", mono_subset$Bacteria), ]
...
str(saccharolyticum_subset)
saccharolyticum_subset$Biomass_community
#----------------------------------------------------------------------------------------------------------------------------------
...
# Save figure
ggsave("final_plot_AGORA.pdf", plot = final_plot, width = 20, height = 12, units = "in", dpi = 320, bg = "white")
ggsave("final_plot_AGORA.png", plot = final_plot, width = 20, height = 12, units = "in", dpi = 320, bg = "white")
