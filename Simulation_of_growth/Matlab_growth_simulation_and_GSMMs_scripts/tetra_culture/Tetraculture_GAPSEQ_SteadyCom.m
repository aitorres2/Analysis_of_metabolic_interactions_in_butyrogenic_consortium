...
models = {Clostridium_sp_M62; Bacteroides_thetaiotaomicron_VPI_5482; Lacticaseibacillus_paracasei_M38; Bifidobacterium_animalis_lactis_PT33};
Names = {'Clostridium_sp_M62'; 'Bacteroides_thetaiotaomicron_VPI_5482'; 'Lacticaseibacillus_paracasei_M38'; 'Bifidobacterium_animalis_lactis_PT33'};

%% Establish biomass a objective function per model
Clostridium_sp_M62 = changeObjective(Clostridium_sp_M62, 'bio1_biomass', 1);  % Set the biomass reaction coefficient to 1
...
Lacticaseibacillus_paracasei_M38 = changeObjective(Lacticaseibacillus_paracasei_M38, 'bio1_biomass', 1);  % Set the biomass reaction coefficient to 1
...
[Clostridium_sp_M62, Clostridium_sp_M62_ExcsAdded] = ...
    loadCultureMedium(Clostridium_sp_M62, cultureMedium, carbonSource);

[Lacticaseibacillus_paracasei_M38,Lacticaseibacillus_paracasei_M38_ExcsAdded] = ...
    loadCultureMedium(Lacticaseibacillus_paracasei_M38, cultureMedium, carbonSource);
...
Clostridium_sp_M62 =changeRxnBounds(Clostridium_sp_M62,'EX_cpd00007_e0',0,'b');
Bacteroides_thetaiotaomicron_VPI_5482 =changeRxnBounds(Bacteroides_thetaiotaomicron_VPI_5482,'EX_cpd00007_e0',0,'b');
Lacticaseibacillus_paracasei_M38 =changeRxnBounds(Lacticaseibacillus_paracasei_M38,'EX_cpd00007_e0',0,'b');
...
% maximum metabolite uptake rates% Definimos los medios que usaremos:
medioPUC = {
    'EX_cpd11602_e0';... % 'EX_inulin(e)'
    'EX_cpd02298_e0';... FOS
...
for i = 1:length(models)
    for j = 1:length(media)
        ...
        Clostridium_sp_M62 = changeRxnBounds(Clostridium_sp_M62, Clostridium_sp_M62.rxns(cellfun(@isempty, strfind(Clostridium_sp_M62.rxns, 'EX_'))==0), 0, 'l');
        Clostridium_sp_M62 = changeRxnBounds(Clostridium_sp_M62, medium, -rates, 'l');    
        
        fba_model_Clostridium_sp_M62= optimizeCbModel(Clostridium_sp_M62, 'max');
        exc_idx_Clostridium_sp_M62 = cellfun(@isempty, strfind(Clostridium_sp_M62.rxns, 'EX_'))==0;
        
        Lacticaseibacillus_paracasei_M38 = changeRxnBounds(Lacticaseibacillus_paracasei_M38, Lacticaseibacillus_paracasei_M38.rxns(cellfun(@isempty, strfind(Lacticaseibacillus_paracasei_M38.rxns, 'EX_'))==0), 0, 'l');
        Lacticaseibacillus_paracasei_M38 = changeRxnBounds(Lacticaseibacillus_paracasei_M38, medium, -rates, 'l');    
        
        fba_model_Lacticaseibacillus_paracasei_M38= optimizeCbModel(Lacticaseibacillus_paracasei_M38, 'max');
        exc_idx_Lacticaseibacillus_paracasei_M38 = cellfun(@isempty, strfind(Lacticaseibacillus_paracasei_M38.rxns, 'EX_'))==0;
        ...
        Clostridium_sp_M62_mono_table = table(Clostridium_sp_M62.rxns(find(fba_model_Clostridium_sp_M62.v(:,1) ~= 0),1), ...
        fba_model_Clostridium_sp_M62.v(find(fba_model_Clostridium_sp_M62.v(:,1) ~= 0),1), ... 
        'VariableNames',{'rxn','v'});
        ...
        Lacticaseibacillus_paracasei_M38_mono_table = table(Lacticaseibacillus_paracasei_M38 .rxns(find(fba_model_Lacticaseibacillus_paracasei_M38 .v(:,1) ~= 0),1), ...
        fba_model_Lacticaseibacillus_paracasei_M38.v(find(fba_model_Lacticaseibacillus_paracasei_M38.v(:,1) ~= 0),1), ... 
        'VariableNames',{'rxn','v'});
        ...
        writetable(Clostridium_sp_M62_mono_table,'Clostridium_sp_M62_monocultivo_modelseed.xlsx');
        ...
        writetable(Lacticaseibacillus_paracasei_M38_mono_table,'Lacticaseibacillus_paracasei_M38_monocultivo_modelseed.xlsx');
...
ids_Clostridium_sp_M62 = findRxnIDs(Clostridium_sp_M62, targets);
targets_ids_Clostridium_sp_M62 = ids_Clostridium_sp_M62(ids_Clostridium_sp_M62 > 0);
targets_filt_Clostridium_sp_M62 = targets(ids_Clostridium_sp_M62 > 0);
...
ids_Lacticaseibacillus_paracasei_M38  = findRxnIDs(Lacticaseibacillus_paracasei_M38 , targets);
targets_ids_Lacticaseibacillus_paracasei_M38  = ids_Lacticaseibacillus_paracasei_M38 (ids_Lacticaseibacillus_paracasei_M38  > 0);
targets_filt_Lacticaseibacillus_paracasei_M38  = targets(ids_Lacticaseibacillus_paracasei_M38  > 0);
...
figure
hold on
bar(categorical(strrep(targets_filt_Clostridium_sp_M62, '_', '\_')), fba_model_Clostridium_sp_M62.x(targets_ids_Clostridium_sp_M62));
...
figure
hold on
bar(categorical(strrep(targets_filt_Lacticaseibacillus_paracasei_M38, '_', '\_')), fba_model_Lacticaseibacillus_paracasei_M38.x(targets_ids_Lacticaseibacillus_paracasei_M38));
ylabel('mmol gDW-1 h-1');
...
metabolitos_mono_Clostridium_sp_M62= table(targets_filt_Clostridium_sp_M62, ...
    fba_model_Clostridium_sp_M62.x(targets_ids_Clostridium_sp_M62), ... 
...
metabolitos_mono_Lacticaseibacillus_paracasei_M38 = table(targets_filt_Lacticaseibacillus_paracasei_M38 , ...
    fba_model_Lacticaseibacillus_paracasei_M38 .x(targets_ids_Lacticaseibacillus_paracasei_M38 ), ... 
    'VariableNames',{'Metabolite','v'});
...
Clostridium_sp_M62_table = table(EcCom.infoCom.EXsp(find(EcCom.indCom.EXsp(:,1) ~= 0),1), ... 
...
Lacticaseibacillus_paracasei_M38_table=table(EcCom.infoCom.EXsp(find(EcCom.indCom.EXsp(:,3) ~= 0),3), ... 
    sol.full(EcCom.indCom.EXsp(find(EcCom.indCom.EXsp(:,3) ~= 0),3)), ... 
    'VariableNames',{'rxn','v'})

Bifidobacterium_animalis_lactis_PT33_table=table(EcCom.infoCom.EXsp(find(EcCom.indCom.EXsp(:,4) ~= 0),4), ... 
...
Clostridium_sp_M62_table(~Clostridium_sp_M62_table.v,:) = []; % https://www.mathworks.com/matlabcentral/answers/407401-delete-zero-rows-from-a-table
Bacteroides_thetaiotaomicron_VPI_5482_table(~Bacteroides_thetaiotaomicron_VPI_5482_table.v,:) = [];
Lacticaseibacillus_paracasei_M38_table(~Lacticaseibacillus_paracasei_M38_table.v,:) = [];
Bifidobacterium_animalis_lactis_PT33_table(~Bifidobacterium_animalis_lactis_PT33_table.v,:) = [];
com_table(~com_table.v,:) = [];

writetable(Clostridium_sp_M62_table,'Clostridium_sp_M62_consorcio_con_Bacteroides_thetaiotaomicron_VPI_5482_Lacticaseibacillus_paracasei_M38_Bifidobacterium_animalis_lactis_PT33_modelseed.xlsx');
writetable(Bacteroides_thetaiotaomicron_VPI_5482_table,'Bacteroides_thetaiotaomicron_VPI_5482_consorcio_con_Clostridium_sp_M62_Lacticaseibacillus_paracasei_M38_Bifidobacterium_animalis_lactis_PT33_modelseed.xlsx');
writetable(Lacticaseibacillus_paracasei_M38_table,'Lacticaseibacillus_paracasei_M38_consorcio_con_Clostridium_sp_M62_Bacteroides_thetaiotaomicron_VPI_5482_Bifidobacterium_animalis_lactis_PT33_modelseed.xlsx');
writetable(Bifidobacterium_animalis_lactis_PT33_table,'Bifidobacterium_animalis_lactis_PT33_consorcio_con_Clostridium_sp_M62_Bacteroides_thetaiotaomicron_VPI_5482_Lacticaseibacillus_paracasei_M38_modelseed.xlsx');
writetable(com_table,'EX_comunidad_Clostridium_sp_M62_Bacteroides_thetaiotaomicron_VPI_5482_Lacticaseibacillus_paracasei_M38_Bifidobacterium_animalis_lactis_PT33_modelseed.xlsx');

%% Graph for community external metabolites such as butyrate
targets_com_Clostridium_sp_M62 = {'Clostridium_sp_M62bio1_biomass';
    'Clostridium_sp_M62IEX_cpd00211_e0tr';
    'Clostridium_sp_M62IEX_cpd00029_e0tr';
    'Clostridium_sp_M62IEX_cpd00141_e0tr';
    'Clostridium_sp_M62IEX_cpd00159_e0tr'; 
    'Clostridium_sp_M62IEX_cpd00221_e0tr'; 
    'Clostridium_sp_M62IEX_cpd00036_e0tr'; 
    'Clostridium_sp_M62IEX_cpd00047_e0tr'; 
    'Clostridium_sp_M62IEX_cpd11602_e0tr'}; 
 ...
 targets_com_Lacticaseibacillus_paracasei_M38 = {'Lacticaseibacillus_paracasei_M38bio1_biomass';
    'Lacticaseibacillus_paracasei_M38IEX_cpd00211_e0tr';
    'Lacticaseibacillus_paracasei_M38IEX_cpd00029_e0tr';
    'Lacticaseibacillus_paracasei_M38IEX_cpd00141_e0tr';
    'Lacticaseibacillus_paracasei_M38IEX_cpd00159_e0tr'; 
    'Lacticaseibacillus_paracasei_M38IEX_cpd00221_e0tr'; 
    'Lacticaseibacillus_paracasei_M38IEX_cpd00036_e0tr'; 
    'Lacticaseibacillus_paracasei_M38IEX_cpd00047_e0tr'; 
    'Lacticaseibacillus_paracasei_M38IEX_cpd11602_e0tr'};
...
ids_Com_Clostridium_sp_M62 = findRxnIDs(EcCom, targets_com_Clostridium_sp_M62);
targets_ids_Com_Clostridium_sp_M62 = ids_Com_Clostridium_sp_M62(ids_Com_Clostridium_sp_M62 > 0);
targets_filt_Com_Clostridium_sp_M62 = targets_com_Clostridium_sp_M62(ids_Com_Clostridium_sp_M62 > 0);
...
ids_Com_Lacticaseibacillus_paracasei_M38 = findRxnIDs(EcCom, targets_com_Lacticaseibacillus_paracasei_M38);
targets_ids_Com_Lacticaseibacillus_paracasei_M38 = ids_Com_Lacticaseibacillus_paracasei_M38(ids_Com_Lacticaseibacillus_paracasei_M38 > 0);
targets_filt_Com_Lacticaseibacillus_paracasei_M38 = targets_com_Lacticaseibacillus_paracasei_M38(ids_Com_Lacticaseibacillus_paracasei_M38 > 0);
...
figure
hold on
bar(categorical(strrep(targets_filt_Com_Clostridium_sp_M62, '_', '\_')), sol.full(targets_ids_Com_Clostridium_sp_M62));
ylabel('mmol gDW-1 h-1');
xlabel({strrep(Names{1}, '_', '\_')});
...
figure
hold on
bar(categorical(strrep(targets_filt_Com_Lacticaseibacillus_paracasei_M38, '_', '\_')), sol.full(targets_ids_Com_Lacticaseibacillus_paracasei_M38));
ylabel('mmol gDW-1 h-1');
xlabel({strrep(Names{3}, '_', '\_')});
title('mZMB + Inulin Co-culture')
hold off
...
metabolitos_com_Clostridium_sp_M62_table = table(targets_filt_Com_Clostridium_sp_M62, ...
    sol.full(targets_ids_Com_Clostridium_sp_M62), ... 
    'VariableNames',{'Metabolite','v'});
...
metabolitos_com_Lacticaseibacillus_paracasei_M38_table = table(targets_filt_Com_Lacticaseibacillus_paracasei_M38, ...
    sol.full(targets_ids_Com_Lacticaseibacillus_paracasei_M38), ... 
    'VariableNames',{'Metabolite','v'});
...
%% FVA optimizing for metabolite of interest (butyrate)
  options.optBMpercent = 100;
options.rxnNameList = EcCom.rxns(find(contains(EcCom.rxns, 'IEX_cpd00211'))); % poner todos los modelos mutantes creados
options.optGRpercent = [0:1:100];
options.GRtol = 1e-6;
...
%%
grComV = result.GRmax * options.optGRpercent / 100;
lgLabel = {strrep(Names{1}, '_', '\_')};  % for 1 butyrate producing bacteria
% lgLabel = {strrep(Names{1}, '_', '\_');strrep(Names{3}, '_', '\_')}; % for 2 bbutyrate producing bacteria
f = figure;
x_lower = 10; 
x_upper = 0; 
hold on
...
x = [grComV(:); flipud(grComV(:))];
y_max = 0;
for j = 1:length(options.rxnNameList) % if two bacteria j = 1:length(options.rxnNameList); if 1 bacteria: j = 1:length(options.rxnNameList(1))
...
tl(1) = title('\underline{SteadyComFVA butyrate}', 'Interpreter', 'latex');
lgLabel2 = {strrep(Names{1}, '_', '\_')};
lg = legend(lgLabel2);
yl(1) = ylabel('Butyrate flux (mmol gDW^{-1} h^{-1})');
xl(1) = xlabel('Community growth rate (h^{-1})');

% Save the combined figure
saveas(p(j, 1),'EX_combinado_Clostridium_sp_M62_Bacteroides_thetaiotaomicron_VPI_5482_Lacticaseibacillus_paracasei_M38_Bifidobacterium_animalis_lactis_PT33_modelseed.png');
hold off
