...
# Save figure
ggsave("sampling_final_plot_HGF2_lactis_modelseed_final.pdf", plot = final_plot, width = 20, height = 12, units = "in", dpi = 320, bg = "white")
ggsave("sampling_final_plot_HGF2_lactis_modelseed_final.png", plot = final_plot, width = 20, height = 12, units = "in", dpi = 320, bg = "white")
